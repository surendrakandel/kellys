...
const data = [
  {
    ...
    altText: 'Marketing',
    postLink: '#',
    title: 'What recent IRS chages means to you',
...
export default function BlogSection() {
  return (
    <section className="font-sans p-24" id="blog">
      <Container>
        <SectionHeader
          slogan="our blog"
          title="Find out What recent IRS changes means for you and Your businesses..."
        />
